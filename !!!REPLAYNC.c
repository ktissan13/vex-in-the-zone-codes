...
int R_mSec = 30000; 				// 15000, length of autonomous redording in milliseconds
int R_Freq = 150; 						// 50, the frequency of the recording in milliseconds. A lower number may result in errors.
int minBattVoltage = 5000; 	// 7800, the minimum battery voltage at which a recording will be made
