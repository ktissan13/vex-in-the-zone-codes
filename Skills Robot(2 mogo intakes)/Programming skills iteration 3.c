...
task main(){
	...
	while(1){
		if(vexRT[Btn5D] == 1){
			...
			_drivegyro(-1470,50);//increase speed(80)-1530
			//B_mogo(-100);
			...
			dgyro_chassis_init();
			drivebase_PID(550);
			_drivegyro(-680, 120);//increase speed(50)
			drive_chassis_init();
			//_fMogo(-100);//drop intake while moving
				F_mogo(90);
			_driveForward(900, 120);//move faster(100)
				F_mogo(-120);
				wait1Msec(1000);
				F_mogo(0);
			_driveForward(1750, 120);
				F_mogo(100);
				wait1Msec(500);
			_driveBack(1700, -80);
				F_mogo(-50);
			_drivegyro(510, 120); //turn over here 490
			drive_chassis_init();
			_driveForward(620, 120);
			_drivegyro(1600,120);//turn here
			drive_chassis_init();
				F_mogo(120);
				wait1Msec(500);
			_driveForward(650, 120);
				F_mogo(-120);
				wait1Msec(300);
			drivebase_PID(200);
				F_mogo(0);
			_drivegyro(-920, 120);//turn here
			drive_chassis_init();
			_driveForward(700, 120);
			_fMogo(-100);
				drive_chassis(-65);
				wait1Msec(400);
				drive_chassis(5);
